...
using SSVTimeSheet.Middleware.Util;

namespace SSVTimeSheet.Middleware
{
    internal static class VueDevelopmentServerMiddleware
    {
        ...
        {            
            ...
            appBuilder.Use(async (context, next) =>
            {
                ...
                var timeout = TimeSpan.FromSeconds(600); // this is a dev only middleware, long timeout is probably fine
